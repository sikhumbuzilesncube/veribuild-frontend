...
// With Hardware Portal, Plan Checker, and more
// ============================================
...
function App() {
  ...
  const renderHome = () => (
    <div style={{ padding: '20px', maxWidth: '900px', margin: '0 auto', fontFamily: 'Arial, sans-serif' }}>
      <div style={{ textAlign: 'center', marginBottom: '40px', borderBottom: '1px solid #e0e0e0', paddingBottom: '30px' }}>
        <h1 style={{ fontSize: '42px', fontWeight: 'bold', margin: '0 0 5px 0', color: '#1A2B5E' }}>VeriBuild</h1>
        <p style={{ color: '#666', fontSize: '18px', margin: '0 0 25px 0' }}>AI-powered building approval platform</p>
        <div style={{ display: 'flex', gap: '15px', justifyContent: 'center' }}>
          <button onClick={() => setView('login')} style={{ padding: '10px 35px', backgroundColor: '#1A2B5E', color: 'white', border: 'none', borderRadius: '6px', fontSize: '16px', cursor: 'pointer' }}>Login</button>
          <button onClick={() => setView('register')} style={{ padding: '10px 35px', backgroundColor: '#00A896', color: 'white', border: 'none', borderRadius: '6px', fontSize: '16px', cursor: 'pointer' }}>Register</button>
        </div>
      </div>
      <div style={{ backgroundColor: '#f0f4f8', padding: '40px', borderRadius: '12px', marginBottom: '40px', textAlign: 'center' }}>
        <h2 style={{ fontSize: '28px', marginBottom: '10px', color: '#1A2B5E' }}>Streamline Your Building Approvals</h2>
        <p style={{ fontSize: '18px', color: '#333', maxWidth: '600px', margin: '0 auto' }}>VeriBuild connects architects, councils, and the public to make the approval process faster, transparent, and more efficient.</p>
      </div>
      ...
      <div style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '15px', color: '#1A2B5E' }}>Top Architects</h2>
      ...
      <div style={{ borderTop: '1px solid #e0e0e0', paddingTop: '20px', textAlign: 'center', color: '#999', fontSize: '14px' }}>
  ...
  const renderRegister = () => (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      <h2 style={{ fontSize: '28px', fontWeight: 'bold', marginBottom: '20px', color: '#1A2B5E' }}>Register for VeriBuild</h2>
        ...
        {showCouncilOther && (
          <div style={{ marginBottom: '15px', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #ffc107' }}>
            ...
            <div style={{ marginBottom: '10px' }}>
              ...
              <input type="text" placeholder="e.g., Chitungwiza Municipality" value={regCouncilOther} onChange={(e) => setRegCouncilOther(e.target.value)} style={{ width: '100%', padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }} required={showCouncilOther} />
            </div>
            <div>
              <label style={{ display: 'block', marginBottom: '5px' }}>Email for Notification</label>
              <input type="email" placeholder="your@email.com" value={regCouncilNotifyEmail} onChange={(e) => setRegCouncilNotifyEmail(e.target.value)} style={{ width: '100%', padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }} required={showCouncilOther} />
